...
<div class="relative flex items-top min-h-screen bg-gray-100 dark:bg-gray-900 py-4 sm:pt-0">
    <div class="ml-4">
        <h5 class="text-white text-left">Scrabber</h5>
    </div>
    <div class="bg-gray-70 justify-content-center">
        <form action="" method="get">
            <label for="numofp">Num. of Players</label>
            <input type="checkbox" name="numofp" id="numofp">
